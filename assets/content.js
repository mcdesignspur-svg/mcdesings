export const translations = {
    es: {
        ...
        ai_quiz: {
            ...
            business_placeholder: "Ej: Restaurante, Salón de belleza, Tienda online...",
            continue: "Continuar →",
            step2_title: "¿Qué te consume más tiempo ahora mismo?",
            pain_options: [
                "💬 Responder mensajes y atender clientes",
                "📱 Crear contenido para redes sociales",
                "🎯 Conseguir y dar seguimiento a clientes",
                "⚙️ Tareas repetitivas y administración"
            ],
            step3_title: "¿Cuál es tu meta principal?",
            goal_options: [
                "💰 Vender más y conseguir más clientes",
                "⏰ Recuperar tiempo y trabajar menos horas",
                "⭐ Mejorar la atención al cliente",
                "📈 Crecer sin contratar más empleados"
            ],
            loading_title: "Analizando tu operación...",
            loading_subtext: "Mapeando el sistema con IA que mejor encaja",
            ready: "Tu diagnóstico está listo",
            recommended_label: "Sistema recomendado para tu negocio",
            map_input_title: "Entrada",
            map_input_desc: "Captura el lead o solicitud con contexto claro.",
            map_ai_title: "IA",
            map_ai_desc: "Organiza, cualifica y resume lo importante.",
            map_action_title: "Acción",
            map_action_desc: "Activa follow-up, agenda o notificación.",
            impact_label: "Impacto esperado",
            email_title: "¿Quieres que Miguel te envíe el plan completo?",
            email_subtext: "Te mando el breakdown detallado con herramientas, próximos pasos y cómo lo adaptaría a tu negocio.",
            name_placeholder: "Tu nombre",
            email_placeholder: "Tu email",
            phone_placeholder: "WhatsApp (opcional)",
            ...
            popup_title: "¿Tu negocio está<br/>listo para la IA?",
            popup_subtext: "Responde 3 preguntas y descubre exactamente qué herramienta puede ahorrarte tiempo y generar más ventas — personalizado para tu negocio.",
            popup_cta: "Descúbrelo gratis →",
    ...
    en: {
        ...
        ai_quiz: {
            ...
            business_placeholder: "Ex: Restaurant, beauty salon, online store...",
            continue: "Continue →",
            step2_title: "What takes the most time right now?",
            pain_options: [
                "💬 Answering messages and helping customers",
                "📱 Creating social media content",
                "🎯 Getting and following up with customers",
                "⚙️ Repetitive admin and operations"
            ],
            step3_title: "What is your main goal?",
            goal_options: [
                "💰 Sell more and get more customers",
                "⏰ Get time back and work fewer hours",
                "⭐ Improve customer service",
                "📈 Grow without hiring more employees"
            ],
            loading_title: "Analyzing your operation...",
            loading_subtext: "Mapping the AI system that fits best",
            ready: "Your diagnosis is ready",
            recommended_label: "Recommended system for your business",
            map_input_title: "Input",
            map_input_desc: "Captures the lead or request with clear context.",
            map_ai_title: "AI",
            map_ai_desc: "Organizes, qualifies, and summarizes what matters.",
            map_action_title: "Action",
            map_action_desc: "Triggers follow-up, booking, or notification.",
            impact_label: "Expected impact",
            email_title: "Want Miguel to send you the full plan?",
            email_subtext: "I will send the detailed breakdown with tools, next steps, and how I would adapt it to your business.",
            name_placeholder: "Your name",
            email_placeholder: "Your email",
            phone_placeholder: "WhatsApp (optional)",
            plan_cta: "I want my personalized plan →",
            skip: "No thanks, this is enough",
            what_is: "What it is",
            next_step: "🚀 How I would bring it to life",
            review_cta: "I want Miguel to review my case →",
            email_note: "I will also send the details by email.",
            popup_badge: "Free · 30 seconds",
            popup_title: "Is your business<br/>ready for AI?",
            popup_subtext: "Answer 3 questions and discover exactly which tool can save time and generate more sales — personalized for your business.",
            popup_cta: "Find out for free →",
